...
def create_app(test_config=None):
    ...
    map_bounds_min_coords = (cfg.get('maps','limit_min_lon'), cfg.get('maps','limit_max_lat'))
    map_bounds_max_coords = (cfg.get('maps','limit_max_lon'), cfg.get('maps','limit_min_lat'))
    ...
    app.config.from_mapping(
        ...
        MAP_BOUNDS_MIN_COORDS=map_bounds_min_coords, # The min bounds to limit the map to
        MAP_BOUNDS_MAX_COORDS=map_bounds_max_coords, # The max bounds to limit the map to
